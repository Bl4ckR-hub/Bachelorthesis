...
#SBATCH -J windowII+edge+perceptual+subset            # Job name (optional)
...
#SBATCH -N 1
#SBATCH -o logs/windowII+edge+perceptual+subset.out   # Standard output
#SBATCH -e logs/windowII+edge+perceptual+subset.err   # Standard error
...
# 4. Run your script
python -u windowII+edge+perceptual+subset.py
