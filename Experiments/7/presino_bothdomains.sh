...
#SBATCH -J bothdomains_last           # Job name (optional)
...
#SBATCH -N 1
#SBATCH -o logs/bothdomains_last.out   # Standard output
#SBATCH -e logs/bothdomains_last.err   # Standard error
...
# 4. Run your script
python -u presino_bothdomains.py